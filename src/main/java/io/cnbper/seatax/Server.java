...
import io.cnbper.seatax.auth.DefaultRegisterCheckAuthHandler;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        coordinator.init();
        RegisterCheckAuthHandler registerCheckAuthHandler = new DefaultRegisterCheckAuthHandler();
        rpcServer.setHandler(coordinator, registerCheckAuthHandler);
